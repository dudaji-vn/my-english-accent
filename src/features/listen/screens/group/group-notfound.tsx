...
const GroupNotFound = () => {
  ...
  return (
    ...
    // </View>
    <>
      <EmptyData flex={1} marginX={18} title="Hmm...">
        <Text>You haven’t joined any group yet.</Text>
        <Text>Ask your supervisor to join one.</Text>
        <Text marginBottom={10}>Or create your own group.</Text>
